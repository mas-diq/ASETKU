    ...
    private fun getData(extras: Bundle?) {
        if (extras != null) {
            val commpany_1: Double = viewModel.IRRdifferentCount(
                ...
                extras.getString("cashFlow_1_1_3")!!.toDouble(),
            ...
            val commpany_2: Double = viewModel.IRRdifferentCount(
                ...
                extras.getString("cashFlow_2_1_3")!!.toDouble(),
                extras.getString("initialInvestment_2_2")!!.toDouble(),
                extras.getString("discountRate_2_2")!!.toDouble(),
                extras.getString("cashFlow_2_2_1")!!.toDouble(),
                extras.getString("cashFlow_2_2_2")!!.toDouble(),
                extras.getString("cashFlow_2_2_3")!!.toDouble()
            ...
            val commpany_3: Double = viewModel.IRRdifferentCount(
                ...
                extras.getString("cashFlow_3_1_3")!!.toDouble(),
                extras.getString("initialInvestment_3_2")!!.toDouble(),
                extras.getString("discountRate_3_2")!!.toDouble(),
                extras.getString("cashFlow_3_2_1")!!.toDouble(),
                extras.getString("cashFlow_3_2_2")!!.toDouble(),
                extras.getString("cashFlow_3_2_3")!!.toDouble()
            )
