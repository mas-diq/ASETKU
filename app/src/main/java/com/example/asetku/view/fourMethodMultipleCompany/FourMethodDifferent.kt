...
class FourMethodDifferent : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityFourMethodDifferentBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFourMethodDifferentBinding.inflate(layoutInflater)
    ...
    private fun getInfo() {
        binding.info.setOnClickListener {
            val move = Intent(this, FourMethodArticle::class.java)
            startActivity(move)
        }
    }
